...
?>
	...
	<div class="nav-wrap cf">
		<nav id="nav-single" class="cf">
			<div class="nav-next"><?php next_image_link( '%link', ( '<span>' . __( 'Next Image', 'cocoa' ) . '</span>' ) ); ?></div>
			<div class="nav-previous"><?php previous_image_link( '%link', ( '<span>' . __( 'Previous Image', 'cocoa' ) . '</span>' ) ); ?></div>
		</nav><!-- #nav-single -->
	</div><!-- end .nav-wrap -->
